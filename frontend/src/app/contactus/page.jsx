...
export default function ContactUs() {
  ...
  return (
    <div className="py-20 md:py-32" key="contactus">
      ...
      <div className="relative z-50 w-fusall px-4 sm:px-6 lg:px-10 max-w-full md:max-w-4xl  mt-10 md:mt-16 text-white translate-x-[10%] translate-y-[-105%] justify-center align-center rounded-lg text-2xl text-shadow-[2px_2px_4px_#186466]"> 
        ...
        <form className="space-y-6 md:space-y-8" onSubmit={handleSubmit}>
          ...
          <div className="min-h-[2rem] mt-3 translate-y-[1.3rem]">
  {success === true && (
